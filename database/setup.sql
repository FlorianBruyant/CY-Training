...
-- Contains a hashed verification token and expiration date, to validate the email of an account
...
CREATE TABLE "Question" (
    id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    author BIGINT REFERENCES "Account"(id) ON DELETE SET NULL,
...
-- Link an account to the subject it's verfied in
...
COMMENT ON COLUMN "Account_Ban"."expires_at" IS 'NULL = permanent ban';
...
CREATE TRIGGER trigger_question_set_updated_at
